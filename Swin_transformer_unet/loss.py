...
def get_loss():
    ...
    return: criterion
    '''
    criterion = JointEdgeSegLoss(classes=2, upper_bound=1,
       edge_weight=1, seg_weight=1, att_weight=1, dual_weight=1).cuda()
...
class JointEdgeSegLoss(nn.Module):
    ...
    def forward(self, inputs, targets):
        ...
        losses = self.edge_weight * 20 * self.bce2d(edgein, edgemask)
