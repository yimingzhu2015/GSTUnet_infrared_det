...
parser.add_argument('--volume_path', type=str,
                    default='./data/NUAA_SIRST', help='root dir for validation volume data')  # for acdc volume_path=root_dir
parser.add_argument('--dataset', type=str,
                    default='NUAA_SIRST', help='experiment_name')
parser.add_argument('--num_classes', type=int,
                    default=2, help='output channel of network')
parser.add_argument('--list_dir', type=str,
                    default='./lists/lists_NUAA_SIRST', help='list dir')
...
if __name__ == "__main__":
    ...
    snapshot = './output/NUAA/gsepoch_149.pth' # 改
